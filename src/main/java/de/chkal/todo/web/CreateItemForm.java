...
/**
 * This class represents the form which is submitted when the user creates a new item. The classes uses
 * {@link FormParam} to map the form data to fields. The fields are annotated with Bean Validation annotations to
